...
parser.add_argument('--output_dir', type=str,
                    default="./logs/swin_unet", help='output dir')
...
parser.add_argument("--net", type=str, default='swin_unet', choices=['swin_unet', 'unet'])
...
if __name__ == "__main__":
    ...
    if args.net == 'swin_unet':
        ...
        args.output_dir = "./logs/swin_unet"
